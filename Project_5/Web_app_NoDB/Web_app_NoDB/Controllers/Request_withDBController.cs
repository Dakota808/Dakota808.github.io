...
{
    public class Request_withDBController : Controller
    {
        ...
        // GET: Request_withDB/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Request_withDB/Create
